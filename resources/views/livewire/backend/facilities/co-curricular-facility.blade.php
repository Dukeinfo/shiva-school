        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Co-Curricular Facilities</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">Dashboard</a></li>
                                <li class="breadcrumb-item">Portfolio</li>
                                <li class="breadcrumb-item active">Co-Curricular Facilities</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-transparent border-bottom py-3">
                            <h4 class="card-title">Co-Curricular Facilities</h4>
                ...
                <div class="col-md-12">
                 ...
                 @error('desc_guj') <span class="error">{{ $message }}</span> @enderror
                            ...
                            <div class="col-md-3">
                               ...
                               <div>
                                <button type="submit" wire:loading.attr="disabled"  class="btn btn-primary w-md" wire:click="addCoCurricular">Submit</button>
                               
                            </div>
                            <div wire:loading wire:target="addCoCurricular">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-transparent border-bottom py-3">
                            <h4 class="card-title">Manage Co-Curricular Facilities</h4>
                                    ...
                                    <tbody>
                                      @if(isset($records) && count($records)>0 )                      
                                        ...
                                        <td>{{$record->link ?? '' }}</td>
                                            ...
                                            <td>                               
                                                <a href="{{route('edit_cocurricular_facility',['id' => $record->id])}}" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
