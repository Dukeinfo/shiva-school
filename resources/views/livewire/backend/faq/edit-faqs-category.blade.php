                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-4">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label"> Faqs Category (Eng)</label>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label"> Faqs Category (Guj)</label>
                                        <input type="text" class="form-control" id="" wire:model="name_guj" placeholder="Category">
