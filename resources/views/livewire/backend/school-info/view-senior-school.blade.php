...
<h4 class="mb-sm-0 font-size-18"> Senior School</h4>

<div class="page-title-right">
    <ol class="breadcrumb m-0">
        <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">Dashboard</a></li>
        <li class="breadcrumb-item">Portfolio</li>
        <li class="breadcrumb-item active">Senior School</li>
    </ol>
</div>
...
<div class="card-header bg-transparent border-bottom py-3">
    <h4 class="card-title">Senior School</h4>
...
<div class="card">
<div class="card-header bg-transparent border-bottom py-3">
    <h4 class="card-title">Manage Senior School</h4>
            ...
            <tbody>
              @if(isset($records) && count($records)>0 )                      
                ...
                <tr>
                    ...
                    <td>{!!$record->heading ?str_limit($record->heading, $limit=100 ) : '' !!}</td>
                   ...
                   <td>{!!$record->description ?str_limit($record->description, $limit=200 ) : '' !!}</td>
                    ...
                    <td>
                        <a href="{{route('edit_senior_school',['id' => $record->id])}}" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
