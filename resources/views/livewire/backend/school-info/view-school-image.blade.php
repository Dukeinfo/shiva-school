...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Add School Image</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">Dashboard</a></li>
                    <li class="breadcrumb-item">Portfolio</li>
                    <li class="breadcrumb-item active">Add School Image</li>
                </ol>
            </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-transparent border-bottom py-3">
                <h4 class="card-title">Add School Image</h4>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-e">
                        <div class="mb-3">
                            <label class="form-label">Image (width:1000 height:900)</label>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-transparent border-bottom py-3">
                <h4 class="card-title">Manage School Image</h4>
                        ...
                        <tbody>
                          @if(isset($records) && count($records)>0 )                      
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('edit_school_image',['id' => $record->id])}}" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
