...
<h4 class="mb-sm-0 font-size-18"> Junior School</h4>

<div class="page-title-right">
    <ol class="breadcrumb m-0">
        <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">Dashboard</a></li>
        <li class="breadcrumb-item">Portfolio</li>
        <li class="breadcrumb-item active">Junior School</li>
    </ol>
</div>
...
<div class="card">
<div class="card-header bg-transparent border-bottom py-3">
    <h4 class="card-title">Manage Junior School</h4>
              ...
              @if(isset($records) && count($records)>0 )                      
                ...
                <tr>
                   ...
                   <td>{!!$record->description ?str_limit($record->description, $limit=200 ) : '' !!}</td>
                    ...
                    <td>
                        <a href="{{route('edit_junior_school',['id' => $record->id])}}" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
