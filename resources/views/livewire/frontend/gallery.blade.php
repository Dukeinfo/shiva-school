...
<section class="half-section">
                ...
                <div class="row">
                 ...
                 @if(isset($categories) && count($categories)>0  )
                      ...
                      <div class="col margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn">
                                <a href="{{url('/gallery-detail')}}/{{$category->id }}"><img src="{{ isset($category->image) ? getGalleryImage($category->image) : asset('no_image.jpg') }}" alt="" /></a>
                                <div class="position-relative bg-white padding-2-half-rem-all border">
                                    <span class="alt-font font-weight-600 text-extra-medium text-extra-dark-gray d-block margin-10px-bottom">{{$category->name}}</span>
                                    <p>{{Str::limit($category->description, 64) ?? ''}}</p>
                                </div>
                            </div>
 ...
 @endif
                       ...
                       <!-- by feualt data -->      
                 <!--            <div class="col margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn">
                                <a href="{{url('/gallery-detail')}}"><img src="assets/images/blog1.jpg" alt="" /></a>
                                <div class="position-relative bg-white padding-2-half-rem-all border">
                            ...
                            <div class="col margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn">
                                <a href="{{url('/gallery-detail')}}"><img src="assets/images/blog2.jpg" alt="" /></a>
                                <div class="position-relative bg-white padding-2-half-rem-all border">
                            ...
                            <div class="col margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn">
                                <a href="{{url('/gallery-detail')}}"><img src="assets/images/blog3.jpg" alt="" /></a>
                                <div class="position-relative bg-white padding-2-half-rem-all border">
     ...
     @if(isset($categories) && count($categories)==0  )                          <!-- show no record found -->
